...
public class LoginPage extends BasePage {
    ...
    public LoginPage(Page page) {
        ...
        // Use specific class-based locators to avoid strict mode violations
        this.emailLabel = page.locator("label.form-field__label[for='email']");
        this.passwordLabel = page.locator("label.form-field__label[for='password']");
