...
public class LoginPage extends BasePage {
    ...
    public LoginPage(Page page) {
        ...
        this.emailLabel = page.getByText("E-mail", new Page.GetByTextOptions().setExact(true));
        this.passwordLabel = page.getByText("Password", new Page.GetByTextOptions().setExact(true));
